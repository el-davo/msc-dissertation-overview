...
\hypersetup{urlcolor=blue, colorlinks=true}  % Colours hyperlinks in black, can be distracting if there are many links and colored blue.
...
\input{Chapters/background.tex} % Background

\input{Chapters/solution-design.tex} % Solution design and implementation

\input{Chapters/results.tex} % Results and Observations
%\input{Chapters/EthicalIssues}

\input{Chapters/conclusions.tex} % Conclusions and Future Work
%% ----------------------------------------------------------------
\label{Bibliography}
